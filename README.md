...
1) You'll need `Docker` locally installed and running

2) From within the project dir run in terminal: `sh development/local-deploy.sh`

3) Step 2) will prompt you directly into running Docker container. Here just run `node app.js`

4) Now you can access the app in browser or Postman from host: `http://localhost:8000`
...
## reference 
1. Udacity Project -Project 1 V2 Boilerplate
2. Opensource Project - https://github.com/gorerider/udacity-blockchain-developer-nanodegree-project-1
